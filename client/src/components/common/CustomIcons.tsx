...
export function GoogleIcon() {
  return (
    <SvgIcon sx={{ width: '24px', height: '24px' }} viewBox="0 0 48 48">
      <svg
        width="48"
        height="48"
        viewBox="0 0 48 48"
      ...
      >
        <path 
          fill="#4285F4" 
          d="M45.12 24.5c0-1.56-.14-3.06-.4-4.5H24v8.51h11.84c-.51 3.25-2.06 5.98-4.38 7.84v5.52h7.11c4.16-3.83 6.56-9.47 6.56-16.37z"
        />
        <path 
          fill="#34A853" 
          d="M24 48c6.48 0 11.93-2.13 15.89-5.82l-7.11-5.52c-2.16 1.45-4.92 2.3-8.78 2.3-6.76 0-12.47-4.55-14.51-10.66H2.3v5.7C6.26 42.4 14.49 48 24 48z"
        />
        <path 
          fill="#FBBC05" 
          d="M9.49 28.19c-.45-1.32-.7-2.73-.7-4.19s.25-2.87.7-4.19v-5.7H2.3C.82 17.05 0 20.42 0 24s.82 6.95 2.3 9.89l7.19-5.7z"
        />
        <path 
          fill="#EA4335" 
          d="M24 9.4c3.48 0 6.31 1.2 8.65 3.45l6.34-6.34C35.91 2.56 30.48 0 24 0 14.49 0 6.26 5.6 2.3 14.11l7.19 5.7c2.04-6.11 7.75-10.41 14.51-10.41z"
        />
  ...
  return (
    <SvgIcon sx={{ width: '24px', height: '24px' }} viewBox="0 0 24 24">
      ...
      >
        <path
          fill="#1877F2"
          d="M15 2h-3.5C7.92 2 5 4.92 5 8.5V12H2v4h3v8h4v-8h3.5l.5-4H9v-1.5c0-1.38 1.12-2.5 2.5-2.5H15V2z"
        />
      </svg>
    </SvgIcon>
  );
